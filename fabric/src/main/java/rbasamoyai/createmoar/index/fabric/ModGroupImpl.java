package rbasamoyai.createmoar.index.fabric;
...
public class ModGroupImpl {
    ...
    public static CreativeModeTab.Builder createBuilder() { return FabricItemGroup.builder(); }

    public static void useModTab(ResourceKey<CreativeModeTab> key) { CreateMOAR.REGISTRATE.setCreativeTab(key); }
